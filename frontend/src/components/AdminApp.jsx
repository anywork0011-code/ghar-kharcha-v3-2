...
import { apiGetUsers, apiCreateUser, apiDeleteUser, apiAdminSummary, apiGetExpenses } from '../api.js'
                  ...
                  {summaries.length===0 ? (
                    ...
                    <div key={us.user._id} style={{background:'#1a1a25',borderRadius:14,border:'1px solid #2a2a40',overflow:'hidden',marginBottom:9}}>
                      ...
                      <div style={{display:'flex',borderTop:'1px solid #2a2a40',background:'#16161e'}}>
                        <button onClick={()=>{setSelUser(us.user);setScreen('view')}} style={{flex:1,padding:'9px',background:'transparent',color:'#3b82f6',fontSize:11,fontWeight:700,display:'flex',alignItems:'center',justifyContent:'center',gap:4,borderRight:'1px solid #2a2a40'}}>📋 नोंदी पहा</button>
